...
public class DiscountCodeDTO_insert {
...
//	private LocalDateTime update; //更新時間
	...
	public DiscountCodeDTO_insert() {
	}

	

	public DiscountCodeDTO_insert(String discountCodeId, @NotEmpty(message = "折價券名稱: 請勿空白") String discountCode,
			Integer adminId,
			...
			LocalDateTime endDate, LocalDateTime created) {
		super();
